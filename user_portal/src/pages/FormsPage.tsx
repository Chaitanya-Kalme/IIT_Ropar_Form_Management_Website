          ...
          return (
            ...
            >
              <Card className="flex h-full flex-col border-0 shadow-card form-card-hover overflow-hidden">
                <div className={`h-1.5 w-full ${colors.bg.replace("100", "400")}`} style={{
                  background: form.category === "Medical Forms" ? "linear-gradient(90deg, #f43f5e, #fb7185)" :
                    form.category === "Academic Forms" ? "linear-gradient(90deg, #6366f1, #818cf8)" :
                    form.category === "Administrative Forms" ? "linear-gradient(90deg, #14b8a6, #2dd4bf)" :
                    form.category === "Finance Forms" ? "linear-gradient(90deg, #f59e0b, #fbbf24)" :
                ...
                <CardContent className="flex flex-1 flex-col p-5">
                  ...
                  <Link to={`/forms/${form.id}`} className="mt-4">
