    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-hero relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <h2 className="font-heading text-3xl font-bold text-white mb-3">Centralized Forms Portal</h2>
      ...
      <div className="flex flex-1 items-center justify-center px-6 bg-background">
        ...
        >
          ...
          <div className="mb-8 text-center lg:hidden">
            ...
            <h1 className="font-heading text-2xl font-bold text-gradient">Centralized Forms Portal</h1>
            <p className="mt-1 text-sm text-muted-foreground">Indian Institute of Technology Ropar</p>
          </div>
